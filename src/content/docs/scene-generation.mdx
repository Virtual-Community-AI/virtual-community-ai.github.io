...
* Install Blosm on Blender - `install/install_blosm.py` (if it doesn't work, please get blosm from its offical website https://prochitecture.gumroad.com/l/blender-osm)
